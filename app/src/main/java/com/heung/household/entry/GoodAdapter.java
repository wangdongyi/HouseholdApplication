...
public class GoodAdapter extends RecyclerView.Adapter {
    ...
    public GoodAdapter(Context mContext, ArrayList<GoodBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (0 == list.get(position).getAllNum()) {
            //没有库存
        ...
        } else if (list.get(position).getAllNum() == list.get(position).getSelectedNum()) {
            //最大
        ...
        } else if (list.get(position).getSelectedNum() < list.get(position).getAllNum()) {
            //可选
            viewHolder.imageSubtraction.setBackgroundResource(R.drawable.oval_blue);
            viewHolder.imageAdd.setBackgroundResource(R.drawable.oval_blue);
            list.get(position).setCanSubtraction(true);
